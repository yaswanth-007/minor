...
class CountDown:
    def __init__(self, root):
        ...
        self.pause = False
        self.button_frame = Frame(self.window, bg="blue", \
        width=240, height=40)
        self.button_frame.place(x=230, y=150)
        self.time_frame = Frame(self.window, bg="blue", \
        width=480, height=120).place(x=0, y=210)
        time_label = Label(self.window, text="Set The Time", 
        font=("times new roman",20, "bold"), bg='green',fg='red')
        time_label.place(x=180, y=30)

        hour_label = Label(self.window, text="Set no of Hour", 
        font=("times new roman",15), bg='green', fg='white')
        hour_label.place(x=50, y=70)

        minute_label = Label(self.window, text="Set Minutes", 
        font=("times new roman",15), bg='green', fg='white')
        minute_label.place(x=200, y=70)

        second_label = Label(self.window, text="Set Seconds", 
        font=("times new roman",15), bg='green', fg='white')
        ...
        font=('Helvetica',12), bg="gray35", fg="black", 
